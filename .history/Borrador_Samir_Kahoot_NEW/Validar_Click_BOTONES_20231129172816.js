...
buttonRespuesta4.addEventListener("click",click_Respuesta_4);
buttonRespuesta2.addEventListener("click",click_Respuesta_2);
buttonRespuesta3.addEventListener("click",click_Respuesta_3);
