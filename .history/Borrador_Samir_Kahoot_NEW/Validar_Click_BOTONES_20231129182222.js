...
const funcionValidarBotones = () => {
    ...
    const stylesBoton_2 = () => {
        buttonRespuesta2.style.backgroundColor = "re";/* correcta */
    ...
    const stylesBoton_3 = () => {
        buttonRespuesta3.style.backgroundColor = "re";/* correcta */
        buttonRespuesta2.style.backgroundColor = "";
        buttonRespuesta3.style.backgroundColor = "";
        buttonRespuesta1.style.backgroundColor = "";
    ...
    const stylesBoton_4 = () => {
        buttonRespuesta4.style.backgroundColor = "re";/* correcta */
        buttonRespuesta2.style.backgroundColor = "";
        buttonRespuesta3.style.backgroundColor = "";
        buttonRespuesta1.style.backgroundColor = "";
