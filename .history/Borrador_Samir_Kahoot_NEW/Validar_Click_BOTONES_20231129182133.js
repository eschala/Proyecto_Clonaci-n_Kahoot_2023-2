...
const funcionValidarBotones = () => {
    ...
    const stylesBoton_2 = () => {
        buttonRespuesta2.style.backgroundColor = "";/* correcta */
    ...
    const stylesBoton_3 = () => {
        buttonRespuesta3.style.backgroundColor = "";/* correcta */
        buttonRespuesta2.style.backgroundColor = "";
        buttonRespuesta3.style.backgroundColor = "";
        buttonRespuesta1.style.backgroundColor = "";
        buttonRespuesta3.style.backgroundColor = "";/* correcta */
    ...
    const stylesBoton_4 = () => {
        buttonRespuesta4.style.backgroundColor = "";/* correcta */
        buttonRespuesta2.style.backgroundColor = "";
        buttonRespuesta3.style.backgroundColor = "";
        buttonRespuesta1.style.backgroundColor = "";
