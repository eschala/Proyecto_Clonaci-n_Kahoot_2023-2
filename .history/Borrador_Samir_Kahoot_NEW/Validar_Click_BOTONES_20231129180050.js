...
const funcionValidarBotones = () => {
    ...
    const click_Respuesta_1 = () => {
        click++;
        if (click == 1) { buttonRespuesta2.style.backgroundColor = "red";
    else{buttonRespuesta2.style.backgroundColor = "red"} }

    }
    const click_Respuesta_2 = () => {
        click++;
        if (click == 1) { buttonRespuesta3.style.backgroundColor = "red";
    else{buttonRespuesta3.style.backgroundColor = "red"} }

    }
    const click_Respuesta_3 = () => {
        click++;
        if (click == 1) { buttonRespuesta4.style.backgroundColor = "red";
    else{buttonRespuesta4.style.backgroundColor = "red"} }
