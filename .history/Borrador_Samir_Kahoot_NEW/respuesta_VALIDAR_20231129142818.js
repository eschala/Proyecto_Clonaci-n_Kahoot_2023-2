...
const preguntas_String = [
  ...
  const respuesta_String = [
    ["A) Un hombre mirando a una chica mientras su novia lo observa molesta.", "B) Un hombre mirando su teléfono mientras su novia lo abraza."],
    ["A) Un gato.", "B) Un Pokémon."],
    ["A) Un modelo de stock photography.", "B) Un actor famoso."]
  ];
  
  const respuesta_Correcta_String = ["A", "B", "A"];