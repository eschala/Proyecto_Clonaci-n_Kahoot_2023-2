...
var funcionPrueba=()=>{
    ...
    tituloClass_E.innerHTML=contar+ " segundos";
...
const activateTime=()=>{
const timeRunning = setInterval(funcionPrueba,intervalo);
}
const activateTimeOUT=()=>{
const tiempoFuera = setTimeout(funcionPrueba,intervalo*segundos);
}
activateTime();
