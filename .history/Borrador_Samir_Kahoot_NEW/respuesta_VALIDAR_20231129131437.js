...
const container_elem=".container";
const sectionContainer_elem=".sectionContainer";
const sub_Container_2_elem=".sub_Container_2";
const btn_1_elem=".btn_1";
const btn_2_elem=".btn_2";
const h2_elem=".aviso";
const tituloClass_elem=".tituloClass";
